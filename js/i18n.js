...
(function () {
  ...
  const phraseMap = {
    ...
    "Accessible Healthcare for Every Village": { te: "ప్రతి గ్రామానికి అందుబాటులో ఉండే ఆరోగ్య సంరక్షణ", hi: "हर गांव के लिए सुलभ स्वास्थ्य सेवा" },
    "Connecting rural and underserved communities with accessible healthcare, doctors, appointments, health records and emergency support.": { te: "గ్రామీణ మరియు వెనుకబడిన ప్రజలకు అందుబాటులో ఉండే వైద్యం, వైద్యులు, అపాయింట్‌మెంట్లు, ఆరోగ్య రికార్డులు మరియు అత్యవసర సహాయాన్ని అనుసంధానించడం.", hi: "ग्रामीण और वंचित समुदायों को सुलभ स्वास्थ्य सेवा, डॉक्टर, अपॉइंटमेंट, स्वास्थ्य रिकॉर्ड और आपातकालीन सहायता से जोड़ना।" },
    "SwasthyaConnect helps rural and underserved communities find healthcare services, connect with doctors, manage appointments and access health information.": { te: "స్వాస్థ్యకనెక్ట్ గ్రామీణ ప్రజలకు ఆరోగ్య సేవలను కనుగొనడానికి, వైద్యులతో మాట్లాడటానికి, అపాయింట్‌మెంట్‌లను నిర్వహించడానికి మరియు సమాచారాన్ని పొందడానికి సహాయపడుతుంది.", hi: "स्वास्थ्यकनेक्ट ग्रामीण और वंचित समुदायों को स्वास्थ्य सेवाएं खोजने, डॉक्टरों से जुड़ने, अपॉइंटमेंट प्रबंधित करने और स्वास्थ्य जानकारी प्राप्त करने में मदद करता है।" },
    ...
    "Emergency Services: 108 (Ambulance) / 112 (National Emergency)": { te: "అత్యవసర సేవలు: 108 (అంబులెన్స్) / 112 (జాతీయ అత్యవసర సహాయం)", hi: "आपातकालीन सेवाएं: 108 (एम्बुलेंस) / 112 (राष्ट्रीय आपातकाल)" },
    "Emergency Services": { te: "అత్యవసర సేవలు", hi: "आपातकालीन सेवाएं" },
    "Call your local emergency service": { te: "మీ స్థానిక అత్యవసర సేవకు కాల్ చేయండి", hi: "अपनी स्थानीय आपातकालीन सेवा को कॉल करें" },
    "Privacy-focused prototype • Demo data only": { te: "గోప్యత ఆధారిత ప్రోటోటైప్ • డెమో డేటా మాత్రమే", hi: "गोपनीयता-केंद्रित प्रोटोटाइप • केवल डेमो डेटा" },
    "Doctor verification required (Demo Prototype Mode)": { te: "డాక్టర్ ధృవీకరణ అవసరం (డెమో ప్రోటోటైప్ మోడ్)", hi: "डॉक्टर सत्यापन आवश्यक (डेमो प्रोटोटाइप मोड)" },
    "This prototype uses demo data and is not intended for storing real medical information.": { te: "ఈ ప్రోటోటైప్ డెమో డేటాను ఉపయోగిస్తుంది మరియు నిజమైన వైద్య సమాచారాన్ని నిల్వ చేయడానికి ఉద్దేశించబడలేదు.", hi: "यह प्रोटोटाइप डेमो डेटा का उपयोग करता है और वास्तविक चिकित्सा जानकारी संग्रहीत करने के लिए अभिप्रेत नहीं है।" },
    "Low Data Mode": { te: "తక్కువ డేటా మోడ్", hi: "कम डेटा मोड" },
    "⚡ Low Data": { te: "⚡ తక్కువ డేటా", hi: "⚡ कम डेटा" },
    "Find a Doctor": { te: "వైద్యుడిని కనుగొనండి", hi: "डॉक्टर खोजें" },
    "Find Doctor": { te: "డాక్టర్‌ను కనుగొనండి", hi: "डॉक्टर खोजें" },
    "Book Appointment": { te: "అపాయింట్‌మెంట్ బుక్ చేయండి", hi: "अपॉइंटमेंट बुक करें" },
    "Open Voice Assistant": { te: "వాయిస్ అసిస్టెంట్ తెరవండి", hi: "वॉयस असिस्टेंट खोलें" },
    "Emergency Help": { te: "అత్యవసర సహాయం", hi: "आपातकालीन सहायता" },
    ...
    "Ayushman Bharat": { te: "ఆయుష్మాన్ భారత్", hi: "आयुष्मान भारत" },
    "National Health Mission (NHM)": { te: "జాతీయ ఆరోగ్య మిషన్ (NHM)", hi: "राष्ट्रीय स्वास्थ्य मिशन (NHM)" },
    "PM-JANMAN (Tribal Health Mission)": { te: "పీఎం-జన్-మన్ (గిరిజన ఆరోగ్య మిషన్)", hi: "पीएम-जनमन (जनजातीय स्वास्थ्य मिशन)" },
    "PM-JANMAN": { te: "పీఎం-జన్-మన్ (PM-JANMAN)", hi: "पीएम-जनमन (PM-JANMAN)" },
    "Pradhan Mantri Swasthya Suraksha Yojana (PMSSY)": { te: "ప్రధాన మంత్రి స్వాస్థ్య సురక్ష యోజన (PMSSY)", hi: "प्रधानमंत्री स्वास्थ्य सुरक्षा योजना (PMSSY)" },
    "National AIDS Control Programme (NACP)": { te: "జాతీయ ఎయిడ్స్ నియంత్రణ కార్యక్రమం (NACP)", hi: "राष्ट्रीय एड्स नियंत्रण कार्यक्रम (NACP)" },
    ...
    "Rural & Public Healthcare": { te: "గ్రామీణ & ప్రజా ఆరోగ్యం", hi: "ग्रामीण एवं सार्वजनिक स्वास्थ्य" },
    "Rural Healthcare": { te: "గ్రామీణ ఆరోగ్యం", hi: "ग्रामीण स्वास्थ्य" },
    "Universal Health Coverage": { te: "సార్వత్రిక ఆరోగ్య రక్షణ", hi: "सार्वभौमिक स्वास्थ्य कवरेज" },
    "Tribal & Underserved": { te: "గిరిజన & వెనుకబడిన ప్రాంతాలు", hi: "जनजातीय एवं वंचित वर्ग" },
    "Tribal & Underserved Communities": { te: "గిరిజన & వెనుకబడిన వర్గాలు", hi: "जनजातीय एवं वंचित समुदाय" },
    "Healthcare Infrastructure": { te: "ఆరోగ్య మౌలిక సదుపాయాలు", hi: "स्वास्थ्य अवसंरचना" },
    "Disease Prevention": { te: "వ్యాధి నివారణ", hi: "रोग रोकथाम" },
    "Disease Prevention & Public Health": { te: "వ్యాధి నివారణ & ప్రజా ఆరోగ్యం", hi: "रोग रोकथाम एवं जन स्वास्थ्य" },
    "Learn More →": { te: "మరింత సమాచారం →", hi: "और जानें →" },
    "Official Website": { te: "అధికారిక వెబ్‌సైట్", hi: "आधिकारिक वेबसाइट" },
    ...
    "Search government schemes...": { te: "ప్రభుత్వ పథకాలను శోధించండి...", hi: "सरकारी योजनाएं खोजें..." },
    "Potentially Eligible": { te: "అర్హత ఉండే అవకాశం ఉంది", hi: "संभावित रूप से पात्र" },
    "More Information Required": { te: "మరింత సమాచారం అవసరం", hi: "अधिक जानकारी आवश्यक" },
    "Check Official Eligibility": { te: "అధికారిక అర్హతను పరిశీలించండి", hi: "आधिकारिक पात्रता जांचें" },
